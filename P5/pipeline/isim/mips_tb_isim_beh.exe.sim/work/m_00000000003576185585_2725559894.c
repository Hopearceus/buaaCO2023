...
#endif
static const char *ng0 = "C:/Users/123/Desktop/verilog/P5/pipeline/datapath/alu.v";
...
LAB46:    t109 = (t0 + 1048U);
    ...
    t111 = *((char **)t109);
    memset(t112, 0, 8);
    xsi_vlog_unsigned_multiply(t112, 32, t110, 32, t111, 32);
    goto LAB47;
...
LAB90:    memcpy(t181, t217, 8);

LAB91:    goto LAB66;

LAB67:    xsi_vlog_unsigned_bit_combine(t117, 32, t150, 32, t181, 32);
    goto LAB71;

LAB69:    memcpy(t117, t150, 8);
    goto LAB71;

LAB72:    t161 = *((unsigned int *)t150);
...
LAB93:    *((unsigned int *)t221) = 1;

LAB95:    memset(t218, 0, 8);
    t237 = (t221 + 4);
...
LAB105:    if (*((unsigned int *)t218) > 0)
        goto LAB106;

LAB107:    memcpy(t217, t250, 8);

LAB108:    goto LAB86;

LAB87:    xsi_vlog_unsigned_bit_combine(t181, 32, t212, 32, t217, 32);
    goto LAB91;
...
LAB100:    t249 = ((char*)((ng1)));
    t250 = (t0 + 1368U);
    t251 = *((char **)t250);
    xsi_vlogtype_concat(t248, 32, 32, 2U, t251, 16, t249, 16);
    goto LAB101;

LAB102:    t250 = ((char*)((ng1)));
    goto LAB103;

LAB104:    xsi_vlog_unsigned_bit_combine(t217, 32, t248, 32, t250, 32);
    goto LAB108;

LAB106:    memcpy(t217, t248, 8);
    goto LAB108;

}


extern void work_m_00000000003576185585_2725559894_init()
{
	static char *pe[] = {(void *)Cont_29_0};
	xsi_register_didat("work_m_00000000003576185585_2725559894", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000003576185585_2725559894.didat");
