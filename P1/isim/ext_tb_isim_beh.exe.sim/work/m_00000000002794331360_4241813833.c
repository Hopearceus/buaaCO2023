...
#endif
static const char *ng0 = "C:/Users/123/Desktop/verilog/P1/ext.v";
...
LAB20:    t143 = (t0 + 2928);
    ...
    t146 = (t145 + 56U);
    t147 = *((char **)t146);
    xsi_vlog_bit_copy(t147, 0, t3, 0, 32);
...
LAB12:    t34 = (t0 + 1048U);
    ...
    *((unsigned int *)t37) = t46;
    ...
    xsi_vlogtype_concat(t33, 528, 32, 2U, t36, 16, t35, 16);
    goto LAB13;
...
LAB36:    memcpy(t51, t89, 136);

LAB37:    goto LAB15;

LAB16:    xsi_vlog_unsigned_bit_combine(t3, 528, t33, 528, t51, 528);
    goto LAB20;

LAB18:    memcpy(t3, t33, 136);
    goto LAB20;
...
LAB29:    t83 = (t0 + 1048U);
    t84 = *((char **)t83);
    t83 = ((char*)((ng4)));
    xsi_vlogtype_concat(t82, 528, 528, 2U, t83, 512, t84, 16);
    goto LAB30;
...
LAB53:    memcpy(t89, t142, 136);

LAB54:    goto LAB32;

LAB33:    xsi_vlog_unsigned_bit_combine(t51, 528, t82, 528, t89, 528);
    goto LAB37;

LAB35:    memcpy(t51, t82, 136);
    goto LAB37;
...
LAB46:    t121 = ((char*)((ng1)));
    t122 = (t0 + 1048U);
    t123 = *((char **)t122);
    xsi_vlogtype_concat(t120, 528, 32, 2U, t123, 16, t121, 16);
    goto LAB47;
...
LAB48:    t122 = (t0 + 1048U);
    ...
    *((unsigned int *)t131) = t140;
    ...
    xsi_vlogtype_concat(t128, 528, 32, 2U, t130, 16, t129, 16);
    t141 = ((char*)((ng6)));
    xsi_vlog_unsigned_lshift(t142, 528, t128, 528, t141, 32);
    goto LAB49;

LAB50:    xsi_vlog_unsigned_bit_combine(t89, 528, t120, 528, t142, 528);
    goto LAB54;

LAB52:    memcpy(t89, t120, 136);
    goto LAB54;
